...
const Tamil = () => {
  ...
  const images2024 = Array.from(
    { length: 10 },
    (_, i) => `${basePath}tamil/2024/img${i + 1}.jpg`,
  );

  const images2025 = Array.from(
    { length: 45 },
    (_, i) => `${basePath}tamil/2025/img${i + 1}.jpg`,
  );

  const images2026 = Array.from(
    { length: 37 },
    (_, i) => `${basePath}tamil/2026/img${i + 1}.jpg`,
  );

  const videos2024 = [
    `${process.env.PUBLIC_URL}/gallery/video/tamil/2024.mp4`,
  ];

  const videos2025 = [
    `${process.env.PUBLIC_URL}/gallery/video/tamil/2025.mp4`,
  ];

  const videos2026 = [
    `${process.env.PUBLIC_URL}/gallery/video/tamil/2026-1.mp4`,
    `${process.env.PUBLIC_URL}/gallery/video/tamil/2026-2.mp4`,
  ];
  ...
  return (
    <div>
      <h3 className="ms-3 mt-4 mb-3">07 January 2024</h3>
      {/* ✅ Video player */}
      ...
      <h3 className="ms-3 mt-4 mb-3">07 January 2025</h3>
      {/* ✅ Video player */}
      <div style={styles.videoWrapper}>
        <video
          ref={videoRef}
      ...
      <div style={styles.gallery}>
       ...
       <h3 className="ms-3 mt-4 mb-3">07 January 2026</h3>
      {/* ✅ Video player */}
      <div style={styles.videoWrapper}>
        <video
          ref={videoRef}
      ...
      <audio
        ref={audioRef}
        src={`${process.env.PUBLIC_URL}/gallery/audio/tamil.mp3`}
        // loop
      />
