...
const Gopika = () => {
  ...
  const media2026 = [
    ...
    {
      type: "video",
      src: `${process.env.PUBLIC_URL}/gallery/video/gopika/2026.mp4`,
      poster: `${process.env.PUBLIC_URL}/gallery/gopika/2026/video-thumb.webp`,
    },
    // Images
    ...Array.from({ length: 21 }, (_, i) => ({
      type: "image",
      src: `${process.env.PUBLIC_URL}/gallery/gopika/2026/img${i + 1}.webp`,
    })),
  ];
  ...
  return (
    <div style={{ display: "flex" }}>
      <div style={{ marginLeft: "70px", flex: 1 }} className="p-3 pt-1">
        <h3 className="ms-3 mt-4 mb-3">08 April 2026</h3>
        {/* ✅ Gallery */}
        ...
        <audio
          ref={audioRef}
          src={`${process.env.PUBLIC_URL}/gallery/audio/gopika.mp3`}
        />
