...
const Manoj = () => {
  ...
  const media2024 = [
    ...
    {
      type: "video",
      src: `${process.env.PUBLIC_URL}/gallery/video/manoj/2024.mp4`,
      poster: `${process.env.PUBLIC_URL}/gallery/manoj/2024/video-thumb.webp`,
    },
    // Images
    ...Array.from({ length: 168 }, (_, i) => ({
      type: "image",
      src: `${process.env.PUBLIC_URL}/gallery/manoj/2024/img${i + 1}.webp`,
    })),
  ];
  ...
  return (
    <div style={{ display: "flex" }}>
      <div style={{ marginLeft: "70px", flex: 1 }} className="p-3 pt-1">
        <h3 className="ms-3 mt-4 mb-3">20 August 2024</h3>
        {/* ✅ Gallery */}
        ...
        <audio
          ref={audioRef}
          src={`${process.env.PUBLIC_URL}/gallery/audio/manoj.mp3`}
        />
