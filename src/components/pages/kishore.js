...
const Kishore = () => {
  ...
  const media2025 = [
    // Videos
    {
      ...
      poster: `${process.env.PUBLIC_URL}/gallery/kishore/2025/video-thumb1.jpg`,
    },
    {
      type: "video",
      src: `${process.env.PUBLIC_URL}/gallery/video/kishore/2025-2.mp4`,
      poster: `${process.env.PUBLIC_URL}/gallery/kishore/2025/video-thumb2.jpg`,
    },
    // Images
    ...Array.from({ length: 49 }, (_, i) => ({
      type: "image",
      src: `${process.env.PUBLIC_URL}/gallery/kishore/2025/img${i + 1}.jpg`,
    })),
  ];
