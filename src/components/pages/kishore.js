...
const Kishore = () => {
  ...
  const media2025 = [
    ...
    {
      type: "video",
      src: `${process.env.PUBLIC_URL}/gallery/video/kishore/2025-1.mp4`,
      poster: `${process.env.PUBLIC_URL}/gallery/kishore/2025/video-thumb1.webp`,
    },
    {
      type: "video",
      src: `${process.env.PUBLIC_URL}/gallery/video/kishore/2025-2.mp4`,
      poster: `${process.env.PUBLIC_URL}/gallery/kishore/2025/video-thumb2.webp`,
    },
    // Images
    ...Array.from({ length: 49 }, (_, i) => ({
      type: "image",
      src: `${process.env.PUBLIC_URL}/gallery/kishore/2025/img${i + 1}.webp`,
    })),
  ];
  ...
  return (
    <div>
      <h3 className="ms-3 mt-4 mb-3">12 November 2025</h3>
      {/* ✅ Gallery */}
      ...
      <audio
        ref={audioRef}
        src={`${process.env.PUBLIC_URL}/gallery/audio/kishore.mp3`}
      />
