...
const Sanjai = () => {
  ...
  const media2026 = [
    ...
    {
      type: "video",
      src: `${process.env.PUBLIC_URL}/gallery/video/sanjai/2026-1.mp4`,
      poster: `${process.env.PUBLIC_URL}/gallery/sanjai/2026/video-thumb.webp`,
    },
    {
      type: "video",
      src: `${process.env.PUBLIC_URL}/gallery/video/sanjai/2026-2.mp4`,
      poster: `${process.env.PUBLIC_URL}/gallery/sanjai/2026/video-thumb.webp`,
    },
    // Images
  ...
  return (
    <div style={{ display: "flex" }}>
      <div style={{ marginLeft: "70px", flex: 1 }} className="p-3 pt-1">
        <h3 className="ms-3 mt-4 mb-3">28 March 2026</h3>
        {/* ✅ Gallery */}
