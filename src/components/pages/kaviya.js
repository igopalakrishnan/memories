...
const Kaviya = () => {
  ...
  const media2024 = [
    ...
    ...Array.from({ length: 23 }, (_, i) => ({
      type: "image",
      src: `${process.env.PUBLIC_URL}/gallery/kaviya/2024/img${i + 1}.webp`,
    })),
  ];
  ...
  return (
    <div style={{ display: "flex" }}>
      <div style={{ marginLeft: "70px", flex: 1 }} className="p-3 pt-1">
        <h3 className="ms-3 mt-4 mb-3">03 January 2024</h3>
        {/* ✅ Gallery */}
        ...
        <audio
          ref={audioRef}
          src={`${process.env.PUBLIC_URL}/gallery/audio/kaviya.mp3`}
        />
