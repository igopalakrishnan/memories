...
const Kavin = () => {
  ...
  const media2024 = [
    {
      type: "video",
      src: `${process.env.PUBLIC_URL}/gallery/video/kavin/2024.mp4`,
      poster: `${process.env.PUBLIC_URL}/gallery/kavin/2024/video-thumb.webp`,
    },
    ...Array.from({ length: 16 }, (_, i) => ({
      type: "image",
      src: `${process.env.PUBLIC_URL}/gallery/kavin/2024/img${i + 1}.webp`,
    })),
  ];
  // Media for 2025
  const media2025 = [
    {
      type: "video",
      src: `${process.env.PUBLIC_URL}/gallery/video/kavin/2025.mp4`,
      poster: `${process.env.PUBLIC_URL}/gallery/kavin/2025/video-thumb.webp`,
    },
    ...Array.from({ length: 68 }, (_, i) => ({
      type: "image",
      src: `${process.env.PUBLIC_URL}/gallery/kavin/2025/img${i + 1}.webp`,
    })),
  ];
  // Media for 2026
  const media2026 = [
    {
      type: "video",
      src: `${process.env.PUBLIC_URL}/gallery/video/kavin/2026-1.mp4`,
      poster: `${process.env.PUBLIC_URL}/gallery/kavin/2026/video-thumb1.webp`,
    },
    {
      type: "video",
      src: `${process.env.PUBLIC_URL}/gallery/video/kavin/2026-2.mp4`,
      poster: `${process.env.PUBLIC_URL}/gallery/kavin/2026/video-thumb2.webp`,
    },
    ...Array.from({ length: 26 }, (_, i) => ({
      type: "image",
      src: `${process.env.PUBLIC_URL}/gallery/kavin/2026/img${i + 1}.webp`,
    })),
  ];

  // Unified media list across years
  const mediaAll = [...media2024, ...media2025, ...media2026];
