  ...
  const media2024 = [
     {
      ...
      poster: `${process.env.PUBLIC_URL}/gallery/kavin/2024/video-thumb.jpg`,
    },
    ...Array.from({ length: 16 }, (_, i) => ({
      type: "image",
      src: `${process.env.PUBLIC_URL}/gallery/kavin/2024/img${i + 1}.jpg`,
    })),
  ];
  // Media for 2025
  const media2025 = [
    {
      ...
      poster: `${process.env.PUBLIC_URL}/gallery/kavin/2025/video-thumb.jpg`,
    },
    ...Array.from({ length: 68 }, (_, i) => ({
      type: "image",
      src: `${process.env.PUBLIC_URL}/gallery/kavin/2025/img${i + 1}.jpg`,
    })),
  ];
  // Media for 2026
  const media2026 = [
    {
      ...
      poster: `${process.env.PUBLIC_URL}/gallery/kavin/2026/video-thumb1.jpg`,
    },
    {
      type: "video",
      src: `${process.env.PUBLIC_URL}/gallery/video/kavin/2026-2.mp4`,
      poster: `${process.env.PUBLIC_URL}/gallery/kavin/2026/video-thumb2.jpg`,
    },
    ...Array.from({ length: 26 }, (_, i) => ({
      type: "image",
      src: `${process.env.PUBLIC_URL}/gallery/kavin/2026/img${i + 1}.jpg`,
    })),
  ];
