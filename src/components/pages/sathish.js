...
const Sathish = () => {
  ...
  const media2024 = [
    ...
    {
      type: "video",
      src: `${process.env.PUBLIC_URL}/gallery/video/sathish/2024.mp4`,
      poster: `${process.env.PUBLIC_URL}/gallery/sathish/2024/video-thumb.webp`,
    },
    // Images
    ...Array.from({ length: 43 }, (_, i) => ({
      type: "image",
      src: `${process.env.PUBLIC_URL}/gallery/sathish/2024/img${i + 1}.webp`,
    })),
  ];
  ...
  // Navigation
  const handlePrev = () => {
    setCurrentIndex((prev) => (prev > 0 ? prev - 1 : media2024.length - 1));
  };
  const handleNext = () => {
    setCurrentIndex((prev) => (prev < media2024.length - 1 ? prev + 1 : 0));
  };
  ...
  return (
    <div>
      <h3 className="ms-3 mt-4 mb-3">24 July 2024</h3>
      {/* ✅ Gallery */}
      ...
      <audio
        ref={audioRef}
        src={`${process.env.PUBLIC_URL}/gallery/audio/sathish.mp3`}
      />
      ...
      {currentIndex !== null && (
        ...
        >
          ...
          {media2024[currentIndex].type === "image" ? (
            <img
