...
const Vicky = () => {
  ...
  const images2024 = Array.from(
    { length: 52 },
    (_, i) => `${basePath}vicky/2024/img${i + 1}.jpg`,
  );

  const images2025 = Array.from(
    { length: 53 },
    (_, i) => `${basePath}vicky/2025/img${i + 1}.jpg`,
  );

  const videos2024 = [
    `${process.env.PUBLIC_URL}/gallery/video/vicky/2025-1.mp4`,
  ];
  ...
  return (
    <div>
      <h3 className="ms-3 mt-4 mb-3">20 March 2024</h3>
      {/* ✅ Video player */}
      ...
      <h3 className="ms-3 mt-4 mb-3">20 March 2025</h3>
      {/* ✅ Video player */}
      <div style={styles.videoWrapper}>
        <video
          ref={videoRef}
